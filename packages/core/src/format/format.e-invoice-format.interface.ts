...
export interface EInvoiceFormat {
	 ...
	 *
	 * This ID specifies a particular customization of the invoice format, which
	 * may define additional constraints or extensions to the standard.
	 */
	 ...
	 *
	 * The profile ID identifies a specific usage profile for the e-invoice, often
	 * used to distinguish between different industry-specific implementations.
	 */
	 ...
	 *
	 * This is either 'UBL' (Universal Business Language) or 'CII' (Cross Industry
	 * Invoice), which are both common standards for electronic invoicing.
	 */
	get syntax(): 'UBL' | 'CII';
	 ...
	 *
	 * This method ensures that all required fields in the mapping have reasonable
	 * defaults before further processing.
	 *
	 ...
	 *
	 * @param invoice - The invoice data structure containing all required
	 *   information.
	 * @param options - Additional options influencing invoice generation.
	 * @returns A promise resolving to the generated invoice as a string or a
	 *   Uint8Array, depending on the format.
	 */
	generate(
		invoice: Invoice,
